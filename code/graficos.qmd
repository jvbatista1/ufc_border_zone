...
```{r}
list(lm(`valor-2010` ~ treated, data = df_rdd),
     lm(`valor-2011` ~ treated, data = df_rdd),
     lm(`valor-2012` ~ treated, data = df_rdd),
     lm(`valor-2013` ~ treated, data = df_rdd),
     lm(`valor-2014` ~ treated, data = df_rdd)) %>%
  stargazer(type = "text")
```
